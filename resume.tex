...
\name{Tony}{Siu}
\position{Data Analyst{\enskip\cdotp\enskip}Computer Vision Engineer{\enskip\cdotp\enskip} Private Researcher}
\address{Taipei, Taiwan}

\mobile{(+886) 0902250365}
\email{pysolver33@gmail.com}
\homepage{www.thepysolver.com}
...
\quote{``The Fool is the Precursor to the Savior"}
